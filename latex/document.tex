...
O presente estudo também abrange uma pesquisa de campo, de acordo com
...
\begin{figure}[!htbp]
  \centering
  \caption{Memorização de Acessos em Navegadores}
  \begin{tikzpicture}
  \pie[
      text=legend,
      sum=auto,
...
\begin{figure}[htb]
    \centering
    \caption{Utilização do Duplo Fator de Autenticação}
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
            xlabel={},
...
\begin{figure}[!htbp]
  \centering
  \caption{Aplicativo para Duplo Fator de Autenticação}
  \begin{tikzpicture}
  \pie[
      text=legend,
      sum=auto,
...
\begin{figure}[!htbp]
  \centering
  \caption{Gerenciamento de Senhas e Credenciais}
  \begin{tikzpicture}
  \pie[
      text=legend,
      sum=auto,
...
\begin{figure}[!htbp]
  \centering
  \caption{Experiências com Problemas de Credenciais Digitais}
  \begin{tikzpicture}
  \pie[
      text=legend,
      sum=auto,
...
\begin{figure}[htb]
    \centering
    \caption{Percepção de Segurança dos Serviços Digitais}
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
...
\begin{figure}[htb]
    \centering
    \caption{Confiança na Gestão Pessoal de Credenciais}
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
            symbolic x coords={1, 2, 3, 4, 5},
