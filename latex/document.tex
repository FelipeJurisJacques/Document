...
\begin{figure}[!htbp]
  ...
  \begin{axis}[
      ...
      ylabel={Porcentagem (\%)},
      symbolic x coords={Não tem vivência, Até 5 anos, Até 10 anos, Mais de 10 anos},
      xtick=data,
      nodes near coords,
  ...
  \addplot [fill=blue!30] coordinates {
      (Não tem vivência, 5.9) (Até 5 anos, 29.4) (Até 10 anos, 35.3) (Mais de 10 anos, 29.4)
  };
  \addplot [fill=red!30] coordinates {
      (Não tem vivência, 11.8) (Até 5 anos, 17.6) (Até 10 anos, 41.2) (Mais de 10 anos, 29.4)
  };
  \addplot [fill=green!30] coordinates {
      (Não tem vivência, 23.5) (Até 5 anos, 76.5)
  };
...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
            title={Aplicativo para Duplo Fator de Autenticação},
            xtick=\empty,
            xlabel={},
            ylabel={Porcentagem (\%)},
            symbolic x coords={,},
            ...
            \addplot[fill=orange!30] coordinates {(, 0)};
            \addlegendentry{Duo}

            \addplot[fill=blue!30] coordinates {(, 4)};
            \addlegendentry{Aegis}

            \addplot[fill=brown!30] coordinates {(, 0)};
            \addlegendentry{FreeOTP}

            \addplot[fill=red!30] coordinates {(, 50)};
            \addlegendentry{Google Autenticator}

            \addplot[fill=green!30] coordinates {(, 33)};
            \addlegendentry{Microssoft Autenticator}

            \addplot[fill=yellow!30] coordinates {(, 4)};
            \addlegendentry{Outro}

            \addplot[fill=pink!30] coordinates {(, 0)};
            \addlegendentry{Não utiliza}

            \addplot[fill=red!30] coordinates {(, 8)};
            \addlegendentry{Desconhece autenticação em 2 fatores}
        \end{axis}
    \end{tikzpicture}
