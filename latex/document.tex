...
até mesmo verificação em duas etapas (TFA) é um tipo comum de memdia adicional
...
\begin{itemize}
  ...
  Se o usuário inserir suas credenciais e um código do duplo fator de autentiação, o invasor
