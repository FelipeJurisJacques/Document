...
\begin{figure}[!htbp]
  \centering
  \caption{Memorização de Acessos em Navegadores de Internet}
  \begin{tikzpicture}
  \pie[
      text=legend,
      sum=auto,
...
\begin{figure}[!htbp]
  \centering
  \caption{Aplicativo para Autenticação em 2 Fatores}
  \begin{tikzpicture}
  \pie[
      text=legend,
      sum=auto,
...
\begin{figure}[!htbp]
  \centering
  \caption{Sofreu Problemas com Credenciais Digitais}
  \begin{tikzpicture}
  \pie[
      text=legend,
      sum=auto,
...
\begin{figure}[htb]
    \centering
    \caption{Considera Seguro os Serviços Digitais Utilizados}
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
...
respostas para a pergunta "Você se considera seguro com suas ações de gestão pessoal de suas
credenciais de serviços digitais?".

\begin{figure}[htb]
    \centering
    \caption{Considera Seguro com as Ações Pessoais de Gestão de Credenciais Digitais}
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
            symbolic x coords={1, 2, 3, 4, 5},
