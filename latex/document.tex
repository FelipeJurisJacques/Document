...
"Prefiro senhas simples sempre que possível" e "Utilizo informações pessoais como senha
para não esquecer".
...
\begin{figure}[!htbp]
  ...
  \pie[
      ...
      35/Senhas grandes e aleatórias,
      18/Frases como senhas,
      18/Senhas simples,
      29/Informatização pessoal como senha
  }
  \end{tikzpicture}
...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            width=12cm,
            ylabel={Porcentagem (\%)},
            title={Vivência com Tecnologia},
            symbolic x coords={Trabalha, Estuda, Utiliza},
        ]
            \addplot coordinates {(Trabalha, 5.9) (Estuda, 11.8) (Utiliza, 0.0)};
            \addplot coordinates {(Trabalha, 29.4) (Estuda, 17.6) (Utiliza, 0.0)};
            \addplot coordinates {(Trabalha, 35.3) (Estuda, 41.2) (Utiliza, 23.5)};
            \addplot coordinates {(Trabalha, 29.4) (Estuda, 29.4) (Utiliza, 76.5)};
...
A terceira pergunta do formulário perguntou aos usuários sobre a funcionalidade presente nos
navegadores de internet, que permitem a memorização de acessos, evitando o processo de
autenticação toda vez que o usuário acessa um site.
Como mostra a figura \ref{fig:resposta_3} em que apresenta a distribuição das
respostas para a pergunta "Você memoriza seu acessos em navegadores de internet?".

\begin{figure}[!htbp]
  \centering
  \caption*{\normalfont Memorização de Acessos em Navegadores}
  \begin{tikzpicture}
  \pie[
      text=inside,
      sum=auto,
  ...
  \end{tikzpicture}
  \caption{Terceira pergunta da pesquisa. Fonte: elaborado pelo autor, 2025}
  \label{fig:resposta_3}
\end{figure}

\FloatBarrier
\begin{itemize}
  \item 59\% preferem digitar senhas uma única vez e permaneço autenticado;
  \item 41\% preferem permanecer autenticado apenas para o básico;
  \item 0\% preferem sempre digitar senhas, de preferência em aba anônima.
\end{itemize}

\subsubsection{Utilização do Duplo Fator de Autenticação}

A quarta pergunta do formulário perguntou aos usuários sobre o duplo fator de autenticação.
Como mostra a figura \ref{fig:resposta_4} em que apresenta a distribuição das
respostas para a pergunta "Você utiliza autenticação em 2 fatores?".
...
\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}
  \begin{axis}[
      title={Utilização do Duplo Fator de Autenticação},
      width=14cm,
      height=8cm,
      ybar stacked,
      bar width=1.0cm,
      ...
      ylabel={Porcentagem (\%)},
      symbolic x coords={Não utiliza, Evita utilizar, Utiliza se necessário, Sempre utiliza},
      xtick=data,
      nodes near coords,
  ...
  \addplot [fill=blue!30] coordinates {
      (Não utiliza, 29.4) (Evita utilizar, 11.8) (Utiliza se necessário, 52.9) (Sempre utiliza, 5.9)
  };
  \addplot [fill=red!30] coordinates {
      (Não utiliza, 11.8) (Evita utilizar, 0.0) (Utiliza se necessário, 52.9) (Sempre utiliza, 35.3)
  };
  \addplot [fill=green!30] coordinates {
      (Não utiliza, 17.6) (Evita utilizar, 0.0) (Utiliza se necessário, 64.7) (Sempre utiliza, 17.6)
  };
  \addplot [fill=yellow!30] coordinates {
      (Não utiliza, 17.6) (Evita utilizar, 5.9) (Utiliza se necessário, 58.8) (Sempre utiliza, 17.6)
  };
  \addplot [fill=orange!30] coordinates {
      (Não utiliza, 70.6) (Evita utilizar, 11.8) (Utiliza se necessário, 17.6) (Sempre utiliza, 0.0)
  };
  ...
  \legend{
    ...
    Aplicativo 2FA,
    Dispositivo físico 2FA
  }
  \end{axis}
  \end{tikzpicture}
  \caption{Quarta pergunta da pesquisa. Fonte: elaborado pelo autor, 2025}
...
do formulário perguntou aos usuários se utilizam algum aplicativo para gerenciar
os códigos OTP.
Como mostra a figura \ref{fig:resposta_5} em que apresenta a distribuição das
respostas para a pergunta "Qual aplicativo de autenticação em 2 fatores você utiliza?".

\begin{figure}[!htbp]
  \centering
  \caption*{\normalfont Aplicativo para Duplo Fator de Autenticação}
  \begin{tikzpicture}
  \pie[
      text=legend,
      sum=auto,
      radius=2,
      after number=\%,
      color={red!20, blue!20, green!20, yellow!20, orange!20, purple!20, cyan!20, magenta!20}
  ]{
      8/Desconhece,
      0/Não utiliza,
      50/Google Autenticator,
      33/Microssoft Autenticator,
      0/FreeOTP,
      4/Aegis,
      0/Duo,
      4/Outro
...
\begin{itemize}
  \item 8\% marcou a opção "Desconheço autenticação em 2 fatores", indicando que não conhece
  o conceito de duplo fator de autenticação;

  \item 0\% marcou a opção "Não uso aplicativo", indicando que não utiliza aplicativo
  para gerenciar os códigos OTP;

  \item 50\% utilizam o aplicativo Google Autenticator;

  \item 33\% utilizam o aplicativo Microssoft Autenticator;

  \item 0\% utilizam o aplicativo FreeOTP;

  \item 4\% utilizam o aplicativo Aegis;

  \item 0\% utilizam o aplicativo Duo;

  \item 4\% utilizam outro aplicativo.
\end{itemize}
...
\begin{figure}[!htbp]
  ...
  \pie[
      ...
      45/Recordam,
      27/Navegador \/ celular,
      5/Caderno,
      18/Notas \/ planilhas,
      0/Métodos alternativos,
      5/Outro
  }
  \end{tikzpicture}
...
\begin{figure}[!htbp]
  ...
  \pie[
      ...
      radius=2,
      after number=\%,
      color={red!20, blue!20, green!20, yellow!20, orange!20},
  ]{
      24/Roubado,
      6/Conta falsa,
      0/Prejuízo,
...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
            title={Percepção de Segurança dos Serviços Digitais},
            symbolic x coords={1, 2, 3, 4, 5},
            xtick=data,
            xlabel={Escala de avaliação},
            ylabel={Porcentagem (\%)},
            bar width=0.6cm,
            nodes near coords,
        ]
            \addplot[fill=green!30] coordinates {
                (1,0) (2,0) (3,29) (4,53) (5,18)
            };
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
            title={Confiança na Gestão Pessoal de Credenciais},
            symbolic x coords={1, 2, 3, 4, 5},
            xtick=data,
            xlabel={Escala de avaliação},
            ylabel={Porcentagem (\%)},
